    ...
    <section id="about" className="wrapper section-padding">
      ...
      <div className="mt-20 grid xl:grid-cols-5 gap-20">
        ...
        <div className="lg:col-span-3 text-4xl overflow-hidden">
          ...
          >
            Hello, I am Anika Tasnim Aurony, a passionate web developer
            with a intense focus on MERN stack. I started my web development journey from January 2022. I am fond of programming from my university life.  
          </motion.p>
          {/* STATS */}
        ...
        >
          ...
          >
            ...
            <Image
              src="https://res.cloudinary.com/dihxkysmc/image/upload/v1688309414/Aurony_pzmijg.jpg"
              alt="Anika Tasnim Aurony"
              width={500}
              height={500}
              priority
